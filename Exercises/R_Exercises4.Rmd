...
function. Can you reorder the plots so that you get 4 in one column? Show your
code.
...
5. Use the `iris` dataset to draw boxplots of `Petal.Length` for each of the
species. Show your code.
...
6. Create correlation matrix using only **numeric** observations in the `mtcars`
dataset. Find the correlations that are greater than the absolute value of
`.80`. What pairs of variables are highly correlated? Show your code.
